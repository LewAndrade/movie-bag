...
class ForgotPassword(Resource):
    def post(self):
        ...
        try:
            ...
            expires_at = datetime.timedelta(hours=24)
            reset_token = create_access_token(str(user.id), expires_delta=expires_at)
...
class ResetPassword(Resource):
    def post(self):
        ...
        try:
            ...
            return send_email('[Movie-bag] Password reset successfully',
                              sender='support@movie-bag.com',
                              recipients=[user.email],
                              text_body='Password reset was successfully',
                              html_body='<p>Password reset was successfully</p>')
